...
#Types:
name = "Richard" #Strings - Characters that we want to create/store variables
age = 40 #Integers - Numbers without decimal point
temperature = 23.5 #Floating Numbers / Floats  - Numbers with decimal point
