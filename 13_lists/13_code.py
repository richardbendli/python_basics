...
print(people[0:2]) # pull indexes 0 and 1 (not 2 because the last number is not included in end_index)
print(people[:2])  # pull every index till index number 2 (not 2 because the last number is not included in end_index)
